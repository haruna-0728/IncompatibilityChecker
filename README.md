...
> > ## ⚠️ 本アプリについて(重要)
> 本アプリは、職業訓練校の学習課程において**個人の学習・ポートフォリオ目的で作成したもの**です。
> 実際の医療現場・業務での使用は想定しておらず、**臨床判断や実診療での利用は禁止**します。
>
> - 収録している配合禁忌データは代表的な組み合わせのみであり、**網羅的ではありません**
> - 実際の投薬・配合可否の判断は、必ず添付文書・薬剤部・薬剤師にご確認ください
> - 本アプリの使用によって生じたいかなる不利益についても、作成者は責任を負いません
> - 医療機関等での実運用・業務利用は固く禁止します
---
